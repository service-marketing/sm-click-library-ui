        ...
        >
          ...
          <template #content>
            <div class="bindings-popover">
              ...
              <hr
                v-if="whatsappBindings.length && instagramBindings.length"
                class="bindings-divider"
              />
      ...
      <template #body>
        <div class="bsuid-help-body">
          <p class="bsuid-help-intro">
            O <strong>BSUID</strong> (Business-Scoped User ID) é um
            identificador único criado pela Meta para cada usuário do WhatsApp
            ou Instagram, específico para cada portfólio de negócios.
          </p>

          <div class="bsuid-help-rule">
            <svg
              class="bsuid-help-icon bsuid-help-icon--blue"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
                fill-rule="evenodd"
                d="M10 2a8 8 0 100 16A8 8 0 0010 2zm0 3a1 1 0 011 1v4a1 1 0 11-2 0V6a1 1 0 011-1zm0 8a1 1 0 100 2 1 1 0 000-2z"
                clip-rule="evenodd"
              />
            </svg>
            <span
              >O mesmo contato terá um
              <strong>BSUID diferente para cada instância</strong> conectada ao
              sistema, mesmo que seja o mesmo número. Cada instância de negócio
              enxerga o usuário com seu próprio ID único.</span
            >
          </div>

          <div class="bsuid-help-rule">
            <svg
              class="bsuid-help-icon bsuid-help-icon--green"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
            ...
            <span
              >O BSUID é <strong>permanente</strong> enquanto o usuário não
              trocar de número de telefone.</span
            >
          </div>

          <div class="bsuid-help-rule">
            <svg
              class="bsuid-help-icon"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
            ...
            <span
              >O mesmo vale para o <strong>Instagram</strong>: cada instância
              terá um BSUID diferente para o mesmo perfil do usuário.</span
            >
          </div>

          <div class="bsuid-help-rule">
            <svg
              class="bsuid-help-icon bsuid-help-icon--yellow"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
            ...
            <span
              >Se um usuário <strong>trocar de número</strong>, o BSUID anterior
              se tornará inválido e um novo será gerado automaticamente pela
              Meta.</span
            >
          </div>
          ...
          <div class="bsuid-help-example">
            ...
            <code class="bsuid-help-example__code"
              >BR.13491208655302741918</code
            >
            <span class="bsuid-help-example__note"
              >Prefixo com o código do país (ISO 3166) + identificador único de
              até 128 caracteres</span
            >
          </div>
        </div>
      </template>
...
.bsuid-help-icon--blue {
  color: rgb(96, 165, 250);
}
.bsuid-help-icon--green {
  color: rgb(74, 222, 128);
}
.bsuid-help-icon--yellow {
