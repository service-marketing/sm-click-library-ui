...
.atendente-item:hover {
  background-color: #ebf8ff; /* Cor azul clara */
}
...
.atendente-photo {
  ...
  height: 40px;
  border-radius: 50%;
  background-color: #9ca3af; /* Cor cinza */
}
...
/* Classes de status */
.status-online {
  background-color: #34d399; /* Verde para online */
}

.status-offline {
  background-color: #f87171; /* Vermelho para offline */
}

.status-away {
  background-color: #fbbf24; /* Amarelo para ausente */
}
</style>
