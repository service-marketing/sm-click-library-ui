                    ...
                    <span class="flex items-center  gap-2" v-else>
                        <header class="flex gap-3 items-center flex-shrink-0">
                            ...
                            <div class="relative" v-else-if="selectedInstance.type === 'whatsapp-api-official'">
                                ...
                                <div v-if="selectedInstance?.meta_connection_type === 'coexistence'" class="absolute right-0 left-0 -bottom-4">
                                    <span
                                        class="mx-auto rounded bg-blue-500 px-1 text-[8px] font-bold leading-tight text-white cursor-default"
                                    >
                                        Coex
                                    </span>
                                </div>
                    ...
                    <button
                        ...
                        <div class="flex w-full items-center pl-2 gap-3">
                            ...
                            <div class="relative" v-else-if="inst.type === 'whatsapp-api-official'">
                                ...
                                <div v-if="inst?.meta_connection_type === 'coexistence'" class="absolute right-0 left-0 -bottom-3">
                                    <span
                                        class="mx-auto rounded bg-blue-500 px-1 text-[8px] font-bold leading-tight text-white cursor-default"
                                    >
                                        Coex
