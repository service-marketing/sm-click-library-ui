...
<template>
  ...
  >
    ...
    <template #cell-actions="{ row }">
      <main class="z-50 flex items-center justify-center gap-2">
        ...
        <Popper placement="left" class="preview-popper">
          ...
          <button class="group action-btn action-btn-info">
            ...
            <span
              class="pointer-events-none absolute right-0 -top-3 z-50 m-2 mx-auto -translate-x-1/3 rounded-md bg-slate-700 p-2 text-sm text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100"
              >Pré-visualizar</span
            >
          </button>
        </Popper>
        ...
        >
          ...
          <span
            class="pointer-events-none absolute right-10 -top-3 z-50 m-2 mx-auto  rounded-md bg-slate-700 p-2 text-sm text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100"
            >Excluir</span
          >
        </button>
        ...
        >
          ...
          <span
            class="pointer-events-none absolute right-2 -top-3 z-50 m-2 mx-auto -translate-x-1/3 rounded-md bg-slate-700 p-2 text-sm text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100"
            >Copiar ID</span
          >
        </button>
      </main>
