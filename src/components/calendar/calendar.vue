<template>
    ...
    <div class="calendar">
      ...
      >
        <div class="date-container">
          ...
          <button
            :disabled="day.date < new Date(new Date().setHours(0, 0, 0, 0))"
  ...
  <eventsModal v-model="currentDay.seeEvents">
...
const props = defineProps({
  ...
  token: {
    type: String,
    default:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzI1MTEwNzY3LCJpYXQiOjE3MjUwMjQzNjcsImp0aSI6ImRiY2E3MjIzZTE2NzRmODJiZjQzOWQyNjYwZDIyYTRhIiwidXNlcl9pZCI6IjYyNGRmZTIzLTkyZDAtNDNmMS04MDYxLWEyMzIxZjJiNWViYiJ9.MMlinTjeEFJcIqzYkM3SgPzJrLafE-GLiZn1wQi4ggs",
  },
  currentChat: Object,
});
