...
<template>
  <main class="justify-center p-3 bg-blue-900 flex items-center h-screen">
    <primarySelect
    ...
    <SimpleModal :isOpen="testRender" @update:isOpen="testRender = $event">
      <!-- <template #header>
        <div class="text-white">slot do header</div>
      </template>
      <template #body>
        <div>slot do body</div>
      </template>
      <template #footer>
